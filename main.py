...
TRANSLATIONS = {
    "Chaos at Fazbear's Launcher": {"es": "Chaos at Fazbear's Launcher", "en": "Chaos at Fazbear's Launcher"},
    ...
    "Error: styles.qss not found. Please make sure it's in the same directory.": {"es": "Error: styles.qss no encontrado. Asegúrate de que esté en el mismo directorio.", "en": "Error: styles.qss not found. Please make sure it's in the same directory."},
    "Warning: Custom font file not found at {}. Using default font.": {"es": "Advertencia: Archivo de fuente personalizado no encontrado en {}. Usando fuente predeterminada.", "en": "Warning: Custom font file not found at {}. Using default font."},
    "Game detected at: {}": {"es": "Juego detectado en: {}", "en": "Game detected at: {}"},
    "Game detected but executable not found. Please reinstall.": {"es": "Juego detectado pero ejecutable no encontrado. Por favor, reinstala.", "en": "Game detected but executable not found. Please reinstall."},
    "Game not installed.": {"es": "Juego no instalado.", "en": "Game not installed."},
    "Found executable at root of extracted folder: {}": {"es": "Ejecutable encontrado en la raíz de la carpeta extraída: {}", "en": "Found executable at root of extracted folder: {}"},
    "Found executable recursively: {}": {"es": "Ejecutable encontrado recursivamente: {}", "en": "Ejecutable encontrado recursivamente: {}"},
    "Descargando notas de parche de: {}": {"es": "Descargando notas de parche de: {}", "en": "Downloading patch notes from: {}"},
    "Notas de Parche": {"es": "Notas de Parche", "en": "Patch Notes"},
    "Por:": {"es": "Por:", "en": "By:"},
    "Notas de parche cargadas exitosamente desde Google Sheet.": {"es": "Notas de parche cargadas exitosamente desde Google Sheet.", "en": "Patch notes loaded successfully from Google Sheet."},
    "Error al conectar con Google Sheets: {}\nAsegúrate de tener conexión a internet y la URL correcta.": {"es": "Error al conectar con Google Sheets: {}\nAsegúrate de tener conexión a internet y la URL correcta.", "en": "Error connecting to Google Sheets: {}\nEnsure you have internet connection and correct URL."},
    "Error de red/servidor al cargar patch notes de Google Sheet: {}": {"es": "Error de red/servidor al cargar notas de parche de Google Sheet: {}", "en": "Network/server error loading patch notes from Google Sheet: {}"},
    "Error al procesar el CSV del Google Sheet: {}\nAsegúrate de que el formato sea correcto (CSV) y no haya celdas inesperadas.": {"es": "Error al procesar el CSV del Google Sheet: {}\nAsegúrate de que el formato sea correcto (CSV) y no haya celdas inesperadas.", "en": "Error processing CSV from Google Sheet: {}\nEnsure format is correct (CSV) and no unexpected cells."},
    "Error inesperado al cargar notas de parche: {}": {"es": "Error inesperado al cargar notas de parche: {}", "en": "Unexpected error loading patch notes: {}"},
    ...
    "Error: Could not load English translation file from {}": {"es": "Error: No se pudo cargar el archivo de traducción al inglés desde {}", "en": "Error: Could not load English translation file from {}"},
    "Unknown language code: {}. Defaulting to base texts (Spanish or English if no specific .qm for base).": {"es": "Código de idioma desconocido: {}. Usando textos base (español o inglés si no hay .qm específico para base).", "en": "Unknown language code: {}. Defaulting to base texts (Spanish or English if no specific .qm for base)."},
    ...
    "Warning: Game executable not found after installation. User may need to locate it manually.": {"es": "Advertencia: Ejecutable del juego no encontrado después de la instalación. El usuario podría necesitar localizarlo manualmente.", "en": "Warning: Game executable not found after installation. User may need to locate it manually."},
    "Installation failed: {}": {"es": "Instalación fallida: {}", "en": "Installation failed: {}"},
    "Error: Game executable path not set or found. Please install the game.": {"es": "Error: Ruta del ejecutable del juego no establecida o no encontrada. Por favor, instala el juego.", "en": "Error: Game executable path not set or found. Please install the game."},
    ...
    "Installation is in progress. Do you want to cancel and close the launcher?": {"es": "La instalación está en progreso. ¿Deseas cancelar y cerrar el launcher?", "en": "Installation is in progress. Do you want to cancel and close the launcher?"},
    "Installing: {filename}": {"es": "Instalando: {filename}", "en": "Installing: {filename}"},
    "Localizar juego": {"es": "Localizar juego", "en": "Locate Game"},
    "Selecciona la carpeta donde instalaste el juego": {"es": "Selecciona la carpeta donde instalaste el juego", "en": "Select the folder where you installed the game"},
    "Éxito": {"es": "Éxito", "en": "Success"},
    "¡Ubicación del juego actualizada correctamente!": {"es": "¡Ubicación del juego actualizada correctamente!", "en": "Game location updated successfully!"},
    "Error": {"es": "Error", "en": "Error"},
    "La carpeta seleccionada no parece ser una instalación válida del juego.": {"es": "La carpeta seleccionada no parece ser una instalación válida del juego.", "en": "The selected folder does not appear to be a valid game installation."},
    ...
    "¿Estás seguro de que quieres desinstalar el juego? Se borrarán todos los archivos de la carpeta: {}": {"es": "¿Estás seguro de que quieres desinstalar el juego? Se borrarán todos los archivos de la carpeta: {}", "en": "Are you sure you want to uninstall the game? All files in the folder will be deleted: {}"},
    "Juego desinstalado correctamente.": {"es": "Juego desinstalado correctamente.", "en": "Game uninstalled successfully."},
    "Ocurrió un error al desinstalar el juego: {}": {"es": "Ocurrió un error al desinstalar el juego: {}", "en": "An error occurred while uninstalling the game: {}"},
    "Play Game": {"es": "Jugar", "en": "Play Game"},
    ...
    "El launcher sigue ejecutándose. Haz clic para restaurar.": {"es": "El launcher sigue ejecutándose. Haz clic para restaurar.", "en": "The launcher is still running. Click to restore."},
    "Activar notificaciones del sistema": {"es": "Activar notificaciones del sistema", "en": "Enable system notifications"},
    "Nuevas Notas de Parche": {"es": "Nuevas Notas de Parche", "en": "New Patch Notes"},
    "Notas de Parche Actualizadas": {"es": "Notas de Parche Actualizadas", "en": "Patch Notes Updated"},
    "Se han publicado nuevas notas de parche. ¡Échales un vistazo!": {"es": "Se han publicado nuevas notas de parche. ¡Échales un vistazo!", "en": "New patch notes have been published. Check them out!"},
    "Actualización Disponible": {"es": "Actualización Disponible", "en": "Update Available"},
    "Actualizaciones y Eventos": {"es": "Actualizaciones y Eventos", "en": "Updates & Events"},
    "Límite de Ancho de Banda:": {"es": "Límite de Ancho de Banda:", "en": "Bandwidth Limit:"},
    "Sin límite": {"es": "Sin límite", "en": "Unlimited"},
    "Acceso Beta": {"es": "Acceso Beta", "en": "Beta Access"},
    "Por favor, introduce la contraseña de beta tester:": {"es": "Por favor, introduce la contraseña de beta tester:", "en": "Please enter the beta tester password:"},
    "Error de Acceso": {"es": "Error de Acceso", "en": "Access Error"},
    "Contraseña incorrecta.": {"es": "Contraseña incorrecta.", "en": "Incorrect password."},
    "Update Game": {"es": "Actualizar", "en": "Update"},
    "¡Nueva versión del juego disponible!": {"es": "¡Nueva versión del juego disponible!", "en": "New game version available!"},
    "Confirmar Instalación": {"es": "Confirmar Instalación", "en": "Confirm Installation"},
    "El juego se instalará en la siguiente ubicación:": {"es": "El juego se instalará en la siguiente ubicación:", "en": "The game will be installed in the following location:"},
    "Cambiar...": {"es": "Cambiar...", "en": "Change..."},
    "Crear acceso directo en el escritorio": {"es": "Crear acceso directo en el escritorio", "en": "Create desktop shortcut"},
    "Cancelar": {"es": "Cancelar", "en": "Cancel"},
    "Nueva Versión del Juego Disponible": {"es": "Nueva Versión del Juego Disponible", "en": "New Game Version Available"},
    "Se ha detectado una nueva versión del juego. ¿Deseas actualizar ahora?": {"es": "Se ha detectado una nueva versión del juego. ¿Deseas actualizar ahora?", "en": "A new version of the game has been detected. Would you like to update now?"},
    "Actualizar Ahora": {"es": "Actualizar Ahora", "en": "Update Now"},
    "Exportar partidas": {"es": "Exportar partidas", "en": "Export Saves"},
    "Importar partidas": {"es": "Importar partidas", "en": "Import Saves"},
    "No se encontró la carpeta de partidas guardadas. ¿Has jugado al juego alguna vez?": {"es": "No se encontró la carpeta de partidas guardadas. ¿Has jugado al juego alguna vez?", "en": "Save games folder not found. Have you ever played the game?"},
    "Exportar Partidas Guardadas": {"es": "Exportar Partidas Guardadas", "en": "Export Save Games"},
    "Partidas guardadas exportadas correctamente a: {}": {"es": "Partidas guardadas exportadas correctamente a: {}", "en": "Save games exported successfully to: {}"},
    "Ocurrió un error al exportar las partidas: {}": {"es": "Ocurrió un error al exportar las partidas: {}", "en": "An error occurred while exporting saves: {}"},
    ...
    "Esto reemplazará tus partidas guardadas actuales. ¿Estás seguro?": {"es": "Esto reemplazará tus partidas guardadas actuales. ¿Estás seguro?", "en": "This will replace your current save games. Are you sure?"},
    "Partidas guardadas importadas correctamente.": {"es": "Partidas guardadas importadas correctamente.", "en": "Save games imported successfully."},
    "El archivo seleccionado no es un ZIP válido.": {"es": "El archivo seleccionado no es un ZIP válido.", "en": "The selected file is not a valid ZIP file."},
    "Ocurrió un error al importar las partidas: {}": {"es": "Ocurrió un error al importar las partidas: {}", "en": "An error occurred while importing saves: {}"},
    "No se pudo determinar la ruta de guardado.": {"es": "No se pudo determinar la ruta de guardado.", "en": "Could not determine the save path."},
    "Nueva Versión del Launcher Disponible": {"es": "Nueva Versión del Launcher Disponible", "en": "New Launcher Version Available"},
    "Se ha detectado una nueva versión del launcher ({}). ¿Deseas actualizar ahora?": {"es": "Se ha detectado una nueva versión del launcher ({}). ¿Deseas actualizar ahora?", "en": "A new version of the launcher ({}) has been detected. Would you like to update now?"},
    "Descargando nueva versión del launcher...": {"es": "Descargando nueva versión del launcher...", "en": "Downloading new launcher version..."},
    "Error al descargar la nueva versión del launcher: {}": {"es": "Error al descargar la nueva versión del launcher: {}", "en": "Error downloading new launcher version: {}"},
    "Launcher actualizado con éxito. Por favor, reinicia el launcher.": {"es": "Launcher actualizado con éxito. Por favor, reinicia el launcher.", "en": "Launcher updated successfully. Please restart the launcher."},
    ...
    "Checking for launcher update...": {"es": "Buscando actualización del launcher...", "en": "Checking for launcher update..."},
    "Could not find version or .exe download URL in the latest GitHub release.": {"es": "No se encontró la versión o la URL de descarga del .exe en la última release de GitHub.", "en": "Could not find version or .exe download URL in the latest GitHub release."},
    "No assets found in the latest GitHub release.": {"es": "No se encontraron archivos en la última release de GitHub.", "en": "No assets found in the latest GitHub release."},
    "Network error checking for launcher update: {}": {"es": "Error de red al buscar actualización del launcher: {}", "en": "Network error checking for launcher update: {}"},
    "Invalid JSON response from GitHub API: Missing key {}": {"es": "Respuesta JSON inválida de la API de GitHub: Falta la clave {}", "en": "Invalid JSON response from GitHub API: Missing key {}"},
    "Unexpected error checking for launcher update: {}": {"es": "Error inesperado al buscar actualización del launcher: {}", "en": "Unexpected error checking for launcher update: {}"},
    "An update is available. Would you like to install it now?": {"es": "Hay una actualización disponible. ¿Quieres instalarla ahora?", "en": "An update is available. Would you like to install it now?"}
}
...
class GameLauncher(QWidget):
    ...
    def download_and_update_launcher(self, download_url):
        try:
            ...
            QMessageBox.critical(self, self.tr("Error"), self.tr("Failed to download or launch new launcher: {}").format(str(e)))
    ...
    def export_save_games(self):
        ...
        if not save_games_path or not os.path.isdir(save_games_path):
            QMessageBox.information(self, self.tr("Error"), self.tr("No se encontró la carpeta de partidas guardadas. ¿Has jugado al juego alguna vez?"))
            return
        zip_file_path, _ = QFileDialog.getSaveFileName(self, self.tr("Exportar Partidas Guardadas"), os.path.expanduser("~/Desktop/ChaosAtFazbears_Saves.zip"), "ZIP Files (*.zip)")
        ...
        try:
            ...
            QMessageBox.information(self, self.tr("Éxito"), self.tr("Partidas guardadas exportadas correctamente a: {}").format(zip_file_path))
        except Exception as e:
            QMessageBox.critical(self, self.tr("Error"), self.tr("Ocurrió un error al exportar las partidas: {}").format(e))
    ...
    def import_save_games(self):
        ...
        if not save_games_path:
            ...
            return
        zip_file_path, _ = QFileDialog.getOpenFileName(self, self.tr("Importar Partidas Guardadas"), os.path.expanduser("~/Desktop"), "ZIP Files (*.zip)")
        if not zip_file_path:
            return
        reply = QMessageBox.question(self, self.tr("Confirmar Importación"), self.tr("Esto reemplazará tus partidas guardadas actuales. ¿Estás seguro?"), QMessageBox.StandardButton.Yes | QMessageBox.StandardButton.No, QMessageBox.StandardButton.No)
        ...
        try:
            ...
            QMessageBox.information(self, self.tr("Éxito"), self.tr("Partidas guardadas importadas correctamente."))
        except zipfile.BadZipFile:
            QMessageBox.critical(self, self.tr("Error"), self.tr("El archivo seleccionado no es un ZIP válido."))
        except Exception as e:
            QMessageBox.critical(self, self.tr("Error"), self.tr("Ocurrió un error al importar las partidas: {}").format(e))
    ...
    def on_game_version_checked(self, online_url):
        ...
        if is_update_available:
            ...
            if self.is_initial_version_check:
                ...
                self.show_notification(self.tr("Actualización Disponible"), self.tr("¡Nueva versión del juego disponible!"), "launcher")
    ...
    def check_for_new_patch_notes_background(self):
        ...
        def on_check_finished(html_content, new_date):
            ...
            if new_date and new_date != last_notified_date:
                ...
                self.show_notification(self.tr("Nuevas Notas de Parche"), self.tr("Se han publicado nuevas notas de parche. ¡Échales un vistazo!"), "patch_notes")
    ...
    def create_blurred_background(self):
        ...
        scaled_pixmap = original_pixmap.scaled(self.size(), Qt.AspectRatioMode.IgnoreAspectRatio, Qt.TransformationMode.SmoothTransformation)
    ...
    def closeEvent(self, event):
        if self.tray_checkbox.isChecked():
            ...
            self.hide()
            self.tray_icon.show()
            self.tray_icon.showMessage(self.tr("Launcher en Segundo Plano"), self.tr("El launcher sigue ejecutándose. Haz clic para restaurar."), QSystemTrayIcon.MessageIcon.Information, 2000)
            return
        if hasattr(self, 'extractor_thread') and self.extractor_thread is not None and self.extractor_thread.isRunning():
            reply = QMessageBox.question(self, self.tr("Confirmar Cierre"), self.tr("La instalación está en progreso. ¿Deseas cancelar y cerrar el launcher?"), QMessageBox.StandardButton.Yes | QMessageBox.StandardButton.No, QMessageBox.StandardButton.No)
    ...
    def check_game_status(self):
        ...
        if saved_path and os.path.exists(saved_path):
            marker_file = os.path.join(saved_path, "versions.txt")
    ...
    def init_ui(self):
        ...
        patch_notes_layout.setContentsMargins(30, 30, 30, 30)
        patch_notes_layout.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.patch_notes_loading_label = QLabel(self)
        self.patch_notes_loading_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
        loading_movie = QMovie(resource_path("images/loading_circle.gif"))
        loading_movie.setScaledSize(QSize(100, 100))
        self.patch_notes_loading_label.setMovie(loading_movie)
        loading_movie.start()
        patch_notes_layout.addWidget(self.patch_notes_loading_label)
    ...
    def load_patch_notes(self):
        self.patch_notes_browser.hide()
        self.patch_notes_loading_label.show()
        google_sheet_csv_url = "https://docs.google.com/spreadsheets/d/e/2PACX-1vQ-1_abJseYUz7vn6V84wtpP6EYOjCMtd-19eaBj_-dE-RFP1YRcQKC0Y9wVGO6W4f293zYeP8SueYg/pub?gid=0&single=true&output=csv"
    ...
    def on_patch_notes_loaded(self, html_content, latest_patch_date):
        self.patch_notes_loading_label.hide()
        self.patch_notes_browser.setHtml(html_content)
        self.patch_notes_browser.show()
    ...
    def confirm_uninstall(self):
        if not self.game_installed_path:
            ...
            return
        reply = QMessageBox.question(self, self.tr("Confirmar Desinstalación"), self.tr("¿Estás seguro de que quieres desinstalar el juego? Se borrarán todos los archivos de la carpeta: {}").format(self.game_installed_path), QMessageBox.StandardButton.Yes | QMessageBox.StandardButton.No, QMessageBox.StandardButton.No)
        if reply == QMessageBox.StandardButton.Yes:
            self.uninstall_game()
    ...
    def manually_locate_game(self):
        ...
        if selected_dir:
            marker_file = os.path.join(selected_dir, "versions.txt")
            if os.path.exists(marker_file):
    ...
    def prompt_installation_path(self, is_update=False):
        ...
        if dialog.exec():
            ...
            self.game_installed_path = install_dir
    ...
    def check_for_updates_manual(self):
        ...
        if self.latest_game_url and self.latest_game_url != last_used_url:
            reply = QMessageBox.information(self, self.tr("Actualización Disponible"), self.tr("An update is available. Would you like to install it now?"), QMessageBox.StandardButton.Yes | QMessageBox.StandardButton.No)
            if reply == QMessageBox.StandardButton.Yes:
                self.prompt_installation_path(is_update=True)
        else:
...
if __name__ == "__main__":
    ...
    logging.basicConfig(level=logging.INFO, format='%(asctime)s [%(levelname)s] - %(message)s', filename='launcher_log.txt', filemode='w')
    
    def handle_exception(exc_type, exc_value, exc_traceback):
        if issubclass(exc_type, KeyboardInterrupt):
            sys.__excepthook__(exc_type, exc_value, exc_traceback)
            return
        logging.error("!!! CRASH NO CAPTURADO !!!", exc_info=(exc_type, exc_value, exc_traceback))
        with open("launcher_CRITICAL_ERROR.txt", "w") as f:
            f.write("Un error crítico ha ocurrido. Por favor, reporta este contenido.\n\n")
    ...
    try:
        ...
        logging.info("QApplication creada.")
        ...
        logging.info(f"Idioma inicial cargado: {initial_lang_code}")
        logging.info("Creando SplashScreen...")
        splash = SplashScreen()
        splash.show()
        logging.info("SplashScreen mostrado.")
        start_time = time.time()
        while time.time() - start_time < 3:
            app.processEvents()
            time.sleep(0.01)
        logging.info("Delay de 3 segundos finalizado.")
        logging.info("Creando instancia de GameLauncher...")
        launcher = GameLauncher()
        logging.info("Instancia de GameLauncher creada.")
        logging.info("Mostrando GameLauncher (launcher.show())...")
        launcher.show()
        logging.info("Llamada a launcher.show() completada.")
        logging.info("Cerrando SplashScreen...")
        splash.close()
        del splash
        logging.info("SplashScreen cerrado.")
        logging.info("Entrando al bucle principal de eventos (app.exec)...")
        exit_code = app.exec()
        logging.info(f"Bucle de eventos finalizado con código: {exit_code}")
        sys.exit(exit_code)
    except Exception as e:
        logging.critical("Error fatal durante la inicialización del launcher.", exc_info=True)
        with open("launcher_CRITICAL_ERROR.txt", "w") as f:
            f.write("Un error crítico ocurrió durante la inicialización.\n\n")
